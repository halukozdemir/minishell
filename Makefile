NAME = minishell
SRC = main.c executer/run_env.c executer/run_env2.c executer/executor.c executer/new_exec.c executer/signals.c\
...
builtins/export.c builtins/unset.c builtins/pwd.c \

CC = gcc
CFLAGS = -Wall -Werror -Wextra -I$(PWD)/readline/include
RM = rm -rf
